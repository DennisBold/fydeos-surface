...
/*
 * lru_count - The count of pages on our LRU list.
 *
 ...
 * @purged:	   Initial purge status (ASHMEM_NOT_PURGED or ASHMEM_WAS_PURGED)
...
static int ashmem_mmap(struct file *file, struct vm_area_struct *vma)
{
	 ...
	 * shmem_set_file while we're in staging. -jstutz
	 */
...
static int set_name(struct ashmem_area *asma, void __user *name)
{
	 ...
	 * semaphore and will be waiting for ashmem_mutex, thereby leading to
